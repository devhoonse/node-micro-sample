...
class Logs extends TCPServer {
  ...
  constructor() {
    ...
    * */
    ...
    /*
    * Elastic Search 서버에 연결된 클라이언트 객체를 인스턴스 변수로 할당합니다.
    * */
    this.esClient = new elasticsearch.Client({
      hosts: ['http://elastic:K4DmOeL4Y8lwxb+=-bPy@192.168.0.2:9200'],
      log: 'trace',
    });
  }
  ...
  onRead(socket, data) {
    ...
    /*
    * Elastic Search 로 데이터를 적재합니다.
    * 'microservice-sample' 이라는 인덱스로 데이터를 저장합니다.
    * 저장 타입은 'logs' 입니다.
    * timestamp : ISO 형식
    * */
